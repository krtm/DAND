...
acc_min_samples_split_2 = accuracy_score(pred_min_samples_split_2, labels_test)
acc_min_samples_split_50 = accuracy_score(pred_min_samples_split_50, labels_test)
